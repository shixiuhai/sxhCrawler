...
function sign(e, t) {
    ...
    var It = "test"
      ...
      var  Ct = true;
      console.log(kt(J,X))
    //   , Bt = Et[kt(x, 1311)]("undefined" == typeof window ? "undefined" : (0,
    // esm_typeof.Z)(window), kt(i, 1166) + "ed") ? __webpack_require__.g : window;
    // Et[kt(k, I)]((0,
    // esm_typeof.Z)(Bt), Et[kt(O, B)]) && Bt && Bt[kt(1173, C) + "or"] && Bt[kt(M, D) + "or"][kt(L, O) + "nt"] && Bt[kt(R, j)] && (It = kt(N, F));
    ...
    return {
        ...
        ), MD5([Ot, It, e, Ct ? '{"callFrom":"web"}' : ""].join(""))),
        "X-t": Ot
    }
}

t='/api/sec/v1/sbtsource'
o={
    "callFrom": "web"
}
// console.log(MD5('1682609174277test/api/sec/v1/sbtsource{"callFrom":"web"}'))
// getRealUrl(t, r, n)
var i = sign(t, o) || {};
// '15b3ccb937a285cbc2e7927332ab8560'
//'8c7f2ad538a5498cf23cc1dd0436b33f'